...
$sql = "INSERT INTO documentos (nome, conteudo, tipo, tamanho, data_envio, hora_envio) 
    VALUES ('$nome_documento', '$conteudo_documento', '$tipo_documento', '$tamanho_documento',$hora_envio , NOW())";
